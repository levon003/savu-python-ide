 ...
 * @version 1.0
 */
class ConsoleOptionPanel extends PluginOptionsDialogPanel implements
	...
	private Container createColorsPanel() {
		...
		exceptionsCB = createColorActivateCB(plugin
				.getString("Color.Exceptions"));
	...
	/**
	 * Returns a check box used to toggle whether a color in a console uses a
	 * special color.
	 * 
	 * @param label
	...
	protected void doApplyImpl(Frame owner) {
		...
		Color c = exceptionsCB.isSelected() ? exceptionsButton.getColor()
				: null;
	...
	private boolean notDefaults() {
		return !visibleCB.isSelected()
				...
				|| !ConsoleTextArea.DEFAULT_STDOUT_FG.equals(stdoutButton
						.getColor())
				|| !ConsoleTextArea.DEFAULT_STDERR_FG.equals(stderrButton
						.getColor())
				|| !ConsoleTextArea.DEFAULT_PROMPT_FG.equals(promptButton
						.getColor())
				|| !ConsoleTextArea.DEFAULT_EXCEPTION_FG
						.equals(exceptionsButton.getColor());
	}
	...
	protected void setValuesImpl(Frame owner) {
		...
		stdoutButton.setEnabled(window
				.isStyleUsed(ConsoleTextArea.STYLE_STDOUT));
		stderrCB.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_STDERR));
		stderrButton.setEnabled(window
				.isStyleUsed(ConsoleTextArea.STYLE_STDERR));
		promptCB.setSelected(window.isStyleUsed(ConsoleTextArea.STYLE_PROMPT));
		promptButton.setEnabled(window
				.isStyleUsed(ConsoleTextArea.STYLE_PROMPT));
		exceptionsCB.setSelected(window
				.isStyleUsed(ConsoleTextArea.STYLE_EXCEPTION));
		exceptionsButton.setEnabled(window
				.isStyleUsed(ConsoleTextArea.STYLE_EXCEPTION));

		stdoutButton.setColor(window
				.getForeground(ConsoleTextArea.STYLE_STDOUT));
		stderrButton.setColor(window
				.getForeground(ConsoleTextArea.STYLE_STDERR));
		promptButton.setColor(window
				.getForeground(ConsoleTextArea.STYLE_PROMPT));
		exceptionsButton.setColor(window
