...
/**
 * Action used by an <code>RTextTabbedPane</code> to save all currently open
 * documents.
 * 
...
class SaveAllAction extends StandardAction {
	 ...
	 */
	public SaveAllAction(Savu owner, ResourceBundle msg, Icon icon) {
	...
	public void actionPerformed(ActionEvent e) {
		((Savu) getApplication()).getMainView().saveAllFiles();
	}
