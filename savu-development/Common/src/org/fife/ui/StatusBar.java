...
public class StatusBar extends StatusBarPanel implements MouseListener {
	...
	private static final Color STATUS_BAR_COLOR = new Color(50,50,40); 
	...
	public StatusBar(String defaultStatusMessage, int style) {
		...
		//COLORCHANGE
		status.setBackground(STATUS_BAR_COLOR);
		status.setForeground(Color.WHITE);
		statusMessage.setForeground(Color.WHITE);
		// Add the size grip.
		this.sizeGrip = new SizeGrip();
		this.sizeGrip.setBackground(DockableWindowGroup.C_MAIN_BACKGROUND_COLOR); //TODO HIGH PRIO change this to be the appropriate background color
