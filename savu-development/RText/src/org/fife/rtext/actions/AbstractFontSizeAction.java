...
import org.fife.rtext.plugins.run.RunWindow;
...
abstract class AbstractFontSizeAction extends StandardAction {
	...
	protected static final float MINIMUM_SIZE = 4f;
	 ...
	 * @param delegate
	 *            The RSTA version of this increase/decrease font size action.
	 */
	protected AbstractFontSizeAction(Savu app, RecordableTextAction delegate,
	 ...
	 * @param font
	 *            The font to look at.
	 * @return A font identical to <code>font</code>, but with a different font
	 *         size.
	 */
