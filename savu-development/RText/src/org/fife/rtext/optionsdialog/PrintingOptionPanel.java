 ...
 * @version 1.0
 */
class PrintingOptionPanel extends OptionsDialogPanel implements
		PropertyChangeListener {

	private FontSelector fontSelector;

	private JCheckBox headerCheckBox; // If checked, the user wants a header on
										// printed documents.
	private JCheckBox footerCheckBox; // If checked, the user wants a footer on
										// printed documents.
	// private boolean useHeader; // Internal variable used to remember what the
	// user clicked.
	// private boolean useFooter; // Internal variable used to remember what the
	// user clicked.
	 ...
	 */
	public PrintingOptionPanel(final Savu rtext, final ResourceBundle msg) {
		...
		printFontPanel.setBorder(new OptionPanelBorder(msg
				.getString("OptPrFTitle")));
		...
		printHeaderFooterPanel.setBorder(new OptionPanelBorder(msg
				.getString("OptPrHFL")));
	 ...
	 * 
	 * @param printFont
	 *            The font to display as the current font used for printing. If
	 *            <code>null</code>, then a default is used.
	 * @see #getPrintFont
	 */
