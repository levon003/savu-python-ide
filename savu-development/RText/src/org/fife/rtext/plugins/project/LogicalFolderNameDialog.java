...
public class LogicalFolderNameDialog extends EscapableDialog {
	...
	public LogicalFolderNameDialog(Frame parent, String prevName,
		...
		setModal(true);
		String key = "LogicalFolderNameDialog.Title"
				+ (isNew ? ".Add" : ".Edit");
	 ...
	 * 
	 * @param key
	 *            The key for the button text and mnemonic.
	 * @return The button.
	 */
	...
	private Container createFormPanel(ComponentOrientation o, String prevName) {
		...
		JLabel nameLabel = new JLabel(
				Messages.getString("RenameDialog.Field.Label"));
	 ...
	 * 
	 * @param key
	 *            The (part of the) key to display.
