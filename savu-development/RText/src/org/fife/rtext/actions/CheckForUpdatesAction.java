...
public class CheckForUpdatesAction extends StandardAction {
	 ...
	 */
	private static final String CHECK_URL = "http://fifesoft.com/rtext/latest.properties?clientVersion="
			+ Savu.VERSION_STRING;
	 ...
	 */
	public CheckForUpdatesAction(Savu owner, ResourceBundle msg, Icon icon) {
