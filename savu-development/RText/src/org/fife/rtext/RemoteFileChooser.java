 ...
 * @version 1.0
 */
public class RemoteFileChooser extends EscapableDialog implements
	 ...
	 * 
	 * @param owner
	 *            The rtext window that owns this dialog.
	 */
	public RemoteFileChooser(Savu owner) {
		...
		JButton cancelButton = UIUtil
				.newButton(msg, "Cancel", "CancelMnemonic");
	 ...
	 * 
	 * @param labelFor
	 *            The component this label is labelling.
	 * @param msg
	 *            Used for localizing.
	 * @param keyRoot
	 *            The root of the text and mnemonic keys in <code>msg</code>.
	 * @return The label.
	 */
	 ...
	 * 
	 * @param port
	 *            The port to use, or <code>null</code> if the default for the
	 ...
	 * 
	 * @return The port to use, or <code>-1</code> if the default port should be
	 *         used.
	 */
	...
	public void okPressed() {
		...
		String encoding = encodingCombo.isVisible() ? (String) encodingCombo
	 ...
	 * 
	 * @param visible
	 *            Whether the dialog is to be visible.
	 */
