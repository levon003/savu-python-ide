 ...
 * <p>
 * 
 * Since RText extends <code>AbstractGUIApplication</code>, its actions are kept
 * in a hash map. Thus, this interface contains the keys for all actions, an
 * array of those keys for looping, and the default values for accelerators for
 * all of the actions.
 * <p>
 * 
...
public interface RTextActionInfo {
	...
	//Actions added by PyDE group
	public static final String RUN_ACTION = "runAction";
	public static final String DEBUG_ACTION = "debugAction";
	public static final String TOGGLE_BREAKPOINT_ACTION = "toggleBreakpointAction";
	public static final String TOGGLE_TUTORIAL_ACTION = "toggleTutorialAction";
	public static final String START_TUTORIAL_ACTION = "startTutorialAction";
	public static final String STOP_ACTION = "stopAction"; 
	
	/**
	 * The names of all actions in an array. Note that the order of these action
	 * names MUST be kept in-synch with the default accelerators array below.
	 */
	// TODO: Remove me; should no longer be needed with ActionRegistry
	public static final String[] actionNames = { NEW_ACTION, OPEN_ACTION,
			OPEN_NEWWIN_ACTION, OPEN_REMOTE_ACTION, SAVE_ACTION,
			SAVE_AS_ACTION, SAVE_AS_REMOTE_ACTION, SAVE_WEBPAGE_ACTION,
			SAVE_ALL_ACTION, Savu.EXIT_ACTION_KEY, COPY_AS_RTF_ACTION,
			TIME_DATE_ACTION, TOOL_BAR_ACTION, STATUS_BAR_ACTION,
			LINE_NUMBER_ACTION, NEXT_DOCUMENT_ACTION, PREVIOUS_DOCUMENT_ACTION,
			FILE_PROPERTIES_ACTION, Savu.HELP_ACTION_KEY,
			Savu.ABOUT_ACTION_KEY, OPTIONS_ACTION, HOME_PAGE_ACTION,
			UPDATES_ACTION, DEC_FONT_SIZES_ACTION, INC_FONT_SIZES_ACTION,

			FIND_ACTION, FIND_NEXT_ACTION, REPLACE_ACTION, REPLACE_NEXT_ACTION,
			REPLACE_ALL_ACTION, FIND_IN_FILES_ACTION, REPLACE_IN_FILES_ACTION,
			PRINT_ACTION, PRINT_PREVIEW_ACTION, CLOSE_ACTION, CLOSE_ALL_ACTION,
			GOTO_ACTION, LTR_ACTION, RTL_ACTION, MOVE_FOCUS_LEFT_ACTION,
			MOVE_FOCUS_RIGHT_ACTION, MOVE_FOCUS_UP_ACTION,
			MOVE_FOCUS_DOWN_ACTION, VIEW_SPLIT_HORIZ_ACTION,
			VIEW_SPLIT_NONE_ACTION, VIEW_SPLIT_VERT_ACTION,
			
			RUN_ACTION, DEBUG_ACTION, TOGGLE_BREAKPOINT_ACTION, TOGGLE_TUTORIAL_ACTION, START_TUTORIAL_ACTION, STOP_ACTION
	...
	/**
	 * The default accelerator for all RText actions. Note that this array MUST
	 * be kept in-synch with the actionNames array above.
	 */
	// TODO: Remove me; should no longer be needed with ActionRegistry
	public static final KeyStroke[] defaultActionAccelerators = {
			...
			KeyStroke.getKeyStroke(KeyEvent.VK_I, defaultModifier), null,
			KeyStroke.getKeyStroke(KeyEvent.VK_S, defaultModifier), null, null,
			null, null, null,
			KeyStroke.getKeyStroke(KeyEvent.VK_C, defaultModifier | shift),
			KeyStroke.getKeyStroke(KeyEvent.VK_F5, 0), null, null,
			...
			KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0), null, null, null, null,
			...
			KeyStroke.getKeyStroke(KeyEvent.VK_F4, 0), null,
			KeyStroke.getKeyStroke(KeyEvent.VK_F, defaultShift), null,
			KeyStroke.getKeyStroke(KeyEvent.VK_P, defaultModifier), null,
			KeyStroke.getKeyStroke(KeyEvent.VK_W, defaultModifier), null,
			KeyStroke.getKeyStroke(KeyEvent.VK_L, defaultModifier), null, null,
			...
			KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, defaultAlt), null, null,
			null,
			
			//Added by Pyde, in order: Run, Debug, Add Breakpoint, Toggle Tutorial, Start Tutorial, Stop
			KeyStroke.getKeyStroke(KeyEvent.VK_R, defaultModifier), 
			KeyStroke.getKeyStroke(KeyEvent.VK_D, defaultModifier), 
			KeyStroke.getKeyStroke(KeyEvent.VK_B, defaultModifier), 
			null, 
			null,
			KeyStroke.getKeyStroke(KeyEvent.VK_T, defaultModifier)
