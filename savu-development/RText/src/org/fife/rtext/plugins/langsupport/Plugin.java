...
public class Plugin extends AbstractPlugin {
	...
	public void install(AbstractPluggableGUIApplication app) {
		...
		CompletionXMLParser.setDefaultCompletionClassLoader(getClass()
				.getClassLoader());
		...
		System.setProperty(SourceBrowserPlugin.CUSTOM_HANDLER_PREFIX
				+ RSyntaxTextArea.SYNTAX_STYLE_JAVA,
		...
		System.setProperty(SourceBrowserPlugin.CUSTOM_HANDLER_PREFIX
				+ RSyntaxTextArea.SYNTAX_STYLE_XML,
	...
	public void savePreferences() {
		...
		if (count == 0) {
			...
			for (int i = 0; i < count; i++) {
				...
				if (srcLocFile != null) {
					prefs.java_classpath_src[i] = srcLocFile
							.getLocationAsString();
				}
			}
		}
		prefs.java_checkForBuildPathMods = JarManager
