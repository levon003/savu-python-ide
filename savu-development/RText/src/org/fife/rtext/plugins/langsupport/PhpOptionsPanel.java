...
class PhpOptionsPanel extends OptionsDialogPanel {
	...
	public PhpOptionsPanel() {
		...
		setIcon(new ImageIcon(
				Savu.class
						.getResource("graphics/file_icons/page_white_php.png")));
		...
		aaHtmlKeysLabel = new JLabel(
				msg.getString("Options.Php.AutoActivationHtmlKeys"));
	...
	protected void doApplyImpl(Frame owner) {
		...
		LanguageSupport ls = lsf
				.getSupportFor(SyntaxConstants.SYNTAX_STYLE_PHP);
	...
	protected void setValuesImpl(Frame owner) {
		...
		boolean folding = view
				.isCodeFoldingEnabledFor(SyntaxConstants.SYNTAX_STYLE_PHP);
