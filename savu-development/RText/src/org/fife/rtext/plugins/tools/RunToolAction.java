...
class RunToolAction extends StandardAction {
	 ...
	 *            The tool to run.
	 */
	public RunToolAction(Savu app, Tool tool, ToolDockableWindow l) {
		super(app);
	...
	public void actionPerformed(ActionEvent e) {
		...
		tool.setRText((Savu) getApplication());
	 ...
	 * stays on the current text area. This is useful if the component is in an
	 * unselected tab in a tabbed pane, for example.
	 * 
	 * @param comp
	 *            The component that should be visible.
	 */
	private void showButDontFocus(JComponent comp) {

		JComponent editor = ((Savu) getApplication()).getMainView()
				.getCurrentTextArea();
