 ...
 * <p>
 * 
 * While all fields in this class are public, please use the getters and setters
 * for accessing them for bounds checking, etc.
 * 
...
public class HtmlOptions extends Prefs {
	...
	/**
	 * Returns whether to replace <tt>&lt;i&gt;</tt> and <tt>&lt;b&gt;</tt> with
	 ...
	 * 
	 * @param drop
	 *            Whether to drop empty "<code>p</code>" elements.
	 ...
	 * 
	 * @param clean
	 *            Whether presentational tags should be replaced with style
	 *            rules.
	 * @see #getMakeClean()
	 */
	 ...
	 * 
	 * @param count
	 *            The number of spaces. This should be greater than or equal to
	 *            <tt>-1</tt> (which specifies to use tabs).
	 * @see #getSpaceCount()
	 */
	 ...
	 * 
	 * @param upper
	 *            Whether they should be made upper case.
