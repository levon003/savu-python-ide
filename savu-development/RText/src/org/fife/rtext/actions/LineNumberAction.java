...
/**
 * Action used by an <code>AbstractMainView</code> to enable viewing line
 * numbers for the open documents.
 * 
...
class LineNumberAction extends StandardAction {
	 ...
	 */
	public LineNumberAction(Savu owner, ResourceBundle msg, Icon icon) {
