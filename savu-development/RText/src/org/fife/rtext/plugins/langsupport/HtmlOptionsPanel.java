...
class HtmlOptionsPanel extends OptionsDialogPanel {
	...
	public HtmlOptionsPanel() {
		...
		setIcon(new ImageIcon(
				Savu.class.getResource("graphics/file_icons/html.png")));
		...
		aaKeysLabel = new JLabel(
				msg.getString("Options.Html.AutoActivationKeys"));
	...
	protected void doApplyImpl(Frame owner) {
		...
		LanguageSupport ls = lsf
				.getSupportFor(SyntaxConstants.SYNTAX_STYLE_HTML);
		...
		view.setCodeFoldingEnabledFor(SyntaxConstants.SYNTAX_STYLE_HTML,
				folding);
	...
	protected void setValuesImpl(Frame owner) {
		...
		Savu rtext = (Savu) owner;
		AbstractMainView view = rtext.getMainView();
		boolean folding = view
				.isCodeFoldingEnabledFor(SyntaxConstants.SYNTAX_STYLE_HTML);
