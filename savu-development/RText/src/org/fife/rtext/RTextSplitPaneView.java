...
class RTextSplitPaneView extends AbstractMainView
	 ...
	 *        this view.
	 */
	public RTextSplitPaneView(Savu owner, String[] filesToOpen,
...
//				owner.pack();
	...
	private class ListListener extends MouseAdapter {
		...
		private JPopupMenu createPopupMenu() {
			...
			popup.add(createItem(Savu.SAVE_ACTION));
			popup.add(createItem(Savu.SAVE_AS_ACTION));
			popup.add(createItem(Savu.CLOSE_ACTION));
			popup.addSeparator();
			popup.add(createItem(Savu.FILE_PROPERTIES_ACTION));
			return popup;
		}
