...
public class StoreKeeper {
	 ...
	 * 
	 * @param rtext
	 *            The <code>RText</code> instance to remember.
	 */
	public static void addRTextInstance(Savu rtext) {
	 ...
	 * 
	 * @param rtext
	 *            The <code>RText</code> to remove.
	 * @throws NullPointerException
	 *             If no <code>RText</code> instances have been remembered yet.
	 */
	public static void removeRTextInstance(Savu rtext) {
	 ...
	 * 
	 * @param lnf
	 *            The Look and Feel to change to.
	 */
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				for (int i = 0; i < count; i++) {
					((Savu) rtextInstances.get(i)).updateLookAndFeel(lnf);
				}
			}
		});
	}
