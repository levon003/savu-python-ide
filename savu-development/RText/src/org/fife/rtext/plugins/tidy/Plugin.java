...
/**
 * A plugin that "tidies" source code. This code calls into other libraries for
 * its functionality.
 * 
 * @author Robert Futrell
 * @version 1.0
 */
public class Plugin extends AbstractPlugin implements CurrentTextAreaListener {
	...
	public Plugin(AbstractPluggableGUIApplication app) {
		this.rtext = (Savu) app; // Needed in loadPreferences if error
	}
	...
	/**
	 * Attempts to delete older versions' preferences (&lt;= RText 2.06), since
	 * this plugin has consolidated all preferences into a single file.
	 */
	...
	public void savePreferences() {
		...
		try {
			...
			try {
				props.store(out, "Preferences for the tidy/pretty-print plugin");
			} finally {
				out.close();
			}
