...
abstract class ProjectEntryTreeNode extends AbstractWorkspaceTreeNode {
	...
	/**
	 * Prompts for verification, then removes this project entry from its parent
	 * project.
	 */
	public void handleRemove() {
		...
		String key = (entry instanceof LogicalFolderProjectEntry) ? "Action.RemoveLogicalProjectEntry.Confirm"
