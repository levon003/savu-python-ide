 ...
 * @version 1.0
 */
class TasksOptionPanel extends PluginOptionsDialogPanel implements
		ActionListener, ItemListener, ModifiableTableListener {
	 ...
	 *            The tasks plugin.
	 */
	public TasksOptionPanel(Savu rtext, TasksPlugin plugin) {
		...
		topPanel.setBorder(new OptionPanelBorder(plugin
				.getString("Options.TaskWindow")));
		...
		contentPane.setBorder(new OptionPanelBorder(plugin
				.getString("Options.TaskIdentifiers")));
		add(contentPane);
	 ...
	 * 
	 * @param ids
	 *            The new task identifiers, separated by the '|' character. This
	 ...
	 */
	private class IdentifierDialog extends EscapableDialog implements
