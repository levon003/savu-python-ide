...
public class WorkspaceRootTreeNode extends AbstractWorkspaceTreeNode {
	...
	protected void handleRename() {
		...
		if (newName != null) {
			if (workspace.setName(newName)) {
				...
				String msg = Messages
						.getString("ProjectPlugin.ErrorRenamingWorkspace");
	...
	private class NewProjectAction extends BaseAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			dialog.setDescription(icon,
					Messages.getString("NewProjectDialog.Desc"));
			dialog.setTitle(Messages.getString("NewProjectDialog.Title"));
			dialog.setName(null); // Move focus from desc SelectableLabel to
									// field.
			dialog.setVisible(true);
			String newName = dialog.getName();
			if (newName != null) {
