...
public class ActionFactory implements RTextActionInfo {
	 ...
	 */
	public static void addActions(Savu rtext, RTextPreferences prefs) {
		...
		a = new Savu.ExitAction(rtext, msg, "ExitAction");
		a.setAccelerator(prefs.getAccelerator(Savu.EXIT_ACTION_KEY));
		rtext.addAction(Savu.EXIT_ACTION_KEY, a);

		//Added by PyDE
		a = new RunAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(RUN_ACTION));
		rtext.addAction(RUN_ACTION, a);
		
		a = new DebugAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(DEBUG_ACTION));
		rtext.addAction(DEBUG_ACTION, a);
		
		a = new ToggleBreakpointAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(TOGGLE_BREAKPOINT_ACTION));
		rtext.addAction(TOGGLE_BREAKPOINT_ACTION, a);
		
		a = new ToggleTutorialAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(TOGGLE_TUTORIAL_ACTION));
		rtext.addAction(TOGGLE_TUTORIAL_ACTION, a);
		
		a = new StartTutorialAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(START_TUTORIAL_ACTION));
		rtext.addAction(START_TUTORIAL_ACTION, a);
		
		a = new StopAction(rtext, msg, null);
		a.setAccelerator(prefs.getAccelerator(STOP_ACTION));
		rtext.addAction(STOP_ACTION,  a); 
		...
		a = new Savu.ToggleToolBarAction(rtext, msg, "ToolBarAction");
		a.setAccelerator(prefs.getAccelerator(TOOL_BAR_ACTION));
		rtext.addAction(TOOL_BAR_ACTION, a);

		a = new Savu.ToggleStatusBarAction(rtext, msg, "StatusBarAction");
		...
		a.setAccelerator(prefs.getAccelerator(Savu.HELP_ACTION_KEY));
		rtext.addAction(Savu.HELP_ACTION_KEY, a);

		a = new AboutAction(rtext, msg, "AboutAction");
		a.setAccelerator(prefs.getAccelerator(Savu.ABOUT_ACTION_KEY));
		rtext.addAction(Savu.ABOUT_ACTION_KEY, a);
