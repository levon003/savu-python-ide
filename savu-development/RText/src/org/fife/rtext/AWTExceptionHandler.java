 ...
 * at least 1.4 - 1.6 in Sun JVMs. We cannot simply use
 * <code>Thread.UncaughtExceptionHandler</code>, since it didn't exist in 1.4
 * (and it doesn't work for exceptions thrown while modal dialogs are visible on
 * the EDT anyway).
 * <p>
 * 
