...
class UIOptionPanel extends OptionsDialogPanel implements ActionListener,
	 ...
	 * Constructor.
	 */
	public UIOptionPanel(final Savu rtext, final ResourceBundle msg) {
	...
	private static final SpecialValueComboBox createLookAndFeelComboBox(
		...
		boolean osIsWindows = rtext.getOS()==Savu.OS_WINDOWS;
	...
	public void setMainViewStyle(final int viewStyle) {
		if (viewStyle==Savu.TABBED_VIEW || viewStyle==Savu.SPLIT_PANE_VIEW ||
			viewStyle==Savu.MDI_VIEW)
			mainViewStyle = viewStyle;
		else
			mainViewStyle = Savu.TABBED_VIEW;
