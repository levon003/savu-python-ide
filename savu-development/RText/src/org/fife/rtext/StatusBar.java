...
public class StatusBar extends org.fife.ui.StatusBar
	...
	//COLORCHANGE
	private static final Color STATUS_BAR_COLOR = Savu.MAIN_BACKGROUND_COLOR; 
	 ...
	 */
	public StatusBar(Savu rtext, String defaultMessage, boolean showRowColumn,
		...
		//COLORCHANGE
		//setBackground(new Color(70,70,60));
		...
		c.weightx = 0.0;
		readOnlyIndicator.setForeground(Color.WHITE);
		readOnlyPanel = new StatusBarPanel(new BorderLayout(),
									readOnlyIndicator);
		
		readOnlyPanel.setBackground(STATUS_BAR_COLOR);
		readOnlyPanel.setForeground(Color.WHITE);
		readOnlyIndicator.setEnabled(false);
		addStatusBarComponent(readOnlyPanel, c);

		// Create a Caps lock indicator.
		c.weightx = 0.0;
		capsLockIndicator.setForeground(Color.WHITE);
		capsLockPanel = new StatusBarPanel(new BorderLayout(),
									capsLockIndicator);
		capsLockPanel.setBackground(STATUS_BAR_COLOR); 
		...
		c.weightx = 0.0;
		overwriteModeIndicator.setForeground(Color.WHITE);
		overwritePanel = new StatusBarPanel(new BorderLayout(),
									overwriteModeIndicator);
		overwritePanel.setBackground(STATUS_BAR_COLOR); 
		...
		rowAndColumnIndicator.setForeground(Color.WHITE); 
		temp1.add(rowAndColumnIndicator);
		temp1.setBackground(STATUS_BAR_COLOR);
