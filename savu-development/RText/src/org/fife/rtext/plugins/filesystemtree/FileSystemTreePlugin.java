...
/**
 * A panel displaying all files on the local file system, allowing for quick and
 * easy opening of files without opening the file chooser.
 * 
...
public class FileSystemTreePlugin extends GUIPlugin {
	...
	/**
	 * Loads saved preferences into the <code>prefs</code> member. If this is
	 * the first time through, default values will be returned.
	 * 
	...
	/**
	 * Called just before this <code>Plugin</code> is removed from an RText
	 * instance. Here we uninstall any listeners we registered.
	 * 
	...
	private class BackAction extends StandardAction {
		...
		public BackAction(Savu app, ResourceBundle msg) {
		...
		public void actionPerformed(ActionEvent e) {
			if (rootHistoryOffs > 0) {
				...
				dirLabel.setText(obj instanceof File ? ((File) obj).getName()
						: null);
	...
	/**
	 * Changes the tree view's root to the next one (assuming they've gone back
	 * at least once before).
	 */
	private class ForwardAction extends StandardAction {

		public ForwardAction(Savu app, ResourceBundle msg) {
	...
	private class ViewAction extends StandardAction {
		...
		public ViewAction(Savu app, ResourceBundle msg) {
