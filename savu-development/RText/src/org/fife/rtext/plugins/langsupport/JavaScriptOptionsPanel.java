...
class JavaScriptOptionsPanel extends OptionsDialogPanel {
	...
	public JavaScriptOptionsPanel() {
		...
		setIcon(new ImageIcon(
				Savu.class.getResource("graphics/file_icons/script_code.png")));
		...
		box.setBorder(new OptionPanelBorder(msg
				.getString("Options.General.AutoActivation")));
		cp.add(box);
		...
		aaDelayLabel = new JLabel(
				msg.getString("Options.General.AutoActivationDelay"));
		...
		aaJavaKeysLabel = new JLabel(
				msg.getString("Options.JavaScript.AutoActivationJSKeys"));
		aaJavaKeysLabel.setEnabled(false);
		aaJavaKeysField = new JTextField(".", 10);
		aaJavaKeysField.setEnabled(false);
		aaDocKeysLabel = new JLabel(
				msg.getString("Options.JavaScript.AutoActionDocCommentKeys"));
	...
	private class Listener implements ActionListener, DocumentListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (enabledCB == source) {
			...
			else if (paramAssistanceCB == source || showDescWindowCB == source
				...
				if (!enabledCB.isSelected() || !paramAssistanceCB.isSelected()
						|| !showDescWindowCB.isSelected()
						|| strictCB.isSelected() || e4xCB.isSelected()
