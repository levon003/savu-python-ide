...
/**
 * Action that opens the active language support's "Go to Member" window, if one
 * is available.
 * 
 * @author Robert Futrell
 * @version 1.0
 */
public class GoToMemberAction extends StandardAction implements
		CurrentTextAreaListener {

	public GoToMemberAction(Savu app) {
	 ...
	 * installed Go To Member on C+Shift+O. This must be kept in sync with the
	 * <code>RSTALanguageSupport</code> project.
	 * 
	 * @param style
	 *            The syntax style.
