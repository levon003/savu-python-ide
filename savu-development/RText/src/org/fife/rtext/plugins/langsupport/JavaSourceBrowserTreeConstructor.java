 ...
 * 
 * <ul>
 * <li>Informative icons for each node that describe the access modifiers of an
 * element (public/protected/private, static, final, etc.) and type (method,
 * field, etc.), just like Eclipse.</li>
 * <li>Members are grouped under their parent classes to show logical structure.
 * </li>
...
public class JavaSourceBrowserTreeConstructor {
	...
	public JTree constructSourceBrowserTree(Savu rtext) {
