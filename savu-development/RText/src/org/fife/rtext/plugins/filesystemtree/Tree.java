...
class Tree extends FileSystemTree {
	...
	public Tree(FileSystemTreePlugin plugin) {
		...
		setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createEmptyBorder(3, 0, 0, 0), getBorder()));
	...
	/**
	 * Creates actions for the file system tree that this plugin adds on top of
	 * the defaults.
	 */
	...
	/**
	 * Creates the popup menu for this file system tree. Subclasses can override
	 * this method if they wish to add more menu items to the popup menu.
	 * 
	...
	protected void installKeyboardActions() {
		...
		im.put((KeyStroke) openAction.getValue(Action.ACCELERATOR_KEY),
				"OnEnter");
	...
	private class GoIntoAction extends StandardAction {
		...
		public GoIntoAction(Savu app, ResourceBundle msg) {
	...
	private class OpenAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (newWindow) {
				...
				Savu r = new Savu(null,
						(RTextPreferences) RTextPreferences
				...
				SwingUtilities
						.invokeLater(new OpenInNewWindowRunnable(r, file));
			} else {
				doOpenFile();
			}
		}
	...
	private class OpenInNewWindowRunnable implements Runnable {
		...
		public OpenInNewWindowRunnable(Savu rtext, String file) {
			this.rtext = rtext;
			this.file = file;
		}
