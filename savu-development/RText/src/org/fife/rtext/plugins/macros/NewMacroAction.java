...
class NewMacroAction extends StandardAction {
	 ...
	 */
	public NewMacroAction(MacroPlugin plugin, Savu owner, ResourceBundle msg) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (macro != null) {
			...
			((Savu) getApplication()).openFile(file.getAbsolutePath());
	...
	/**
	 * Creates a new file with initial content for a macro, based on the file's
	 * extension.
	 * 
	 * @param file
