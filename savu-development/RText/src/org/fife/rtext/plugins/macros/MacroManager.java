...
public class MacroManager {
	...
	/**
	 * Removes all macros from this manager. This fires a property change event
	 * of type {@link #PROPERTY_MACROS}.
	 * 
	 ...
	 * 
	 * @param dir
	 *            The directory to load macros from.
	 * @throws IOException
	 *             If an IO error occurs reading the macros.
	 * @see #saveMacros(File)
	 */
	 ...
	 * 
	 * @param dir
	 *            The directory to save the macro definitions to. The old
	 *            contents of this directory are deleted.
	 * @throws IOException
	 *             If an IO error occurs writing the files.
	 * @see #loadMacros(File)
	 */
