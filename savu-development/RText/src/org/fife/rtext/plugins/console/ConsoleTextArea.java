...
/**
 * Text component that displays a console of some type. This component tries to
 * mimic jEdit's "Console" behavior, since that seemed to work pretty well.
 * 
...
abstract class ConsoleTextArea extends JTextPane {
	...
	/**
	 * Appends the prompt to the console, and resets the starting location at
	 * which the user can input text. This method is thread-safe.
	 */
