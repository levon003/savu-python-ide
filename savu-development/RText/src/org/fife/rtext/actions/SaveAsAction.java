...
/**
 * Action used by an <code>RText</code> to save the current document with a new
 * file name.
 * 
...
class SaveAsAction extends StandardAction {
	 ...
	 */
	public SaveAsAction(Savu owner, ResourceBundle msg, Icon icon) {
		super(owner, msg, "SaveAsAction");
		setIcon(icon);
	}

	public void actionPerformed(ActionEvent e) {
		((Savu) getApplication()).getMainView().saveCurrentFileAs();
	}
