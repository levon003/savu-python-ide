...
class IconGroupLoader extends DefaultHandler {
	 ...
	 */
	public static final String DEFAULT_ICON_GROUP_NAME = "Savu Icons";
	 ...
	 */
	private IconGroupLoader(Savu owner) {
		this.owner = owner;
	 ...
	 * of them.
	 *
	 * @param Savu The RText instance.
	 * @param iconGroupFile The file from which to read.
	 * @return A map of icon groups.  The key to each icon group is that
	 *         icon group's name.
	 */
	public static Map loadIconGroups(Savu rtext, String iconGroupFile) {
