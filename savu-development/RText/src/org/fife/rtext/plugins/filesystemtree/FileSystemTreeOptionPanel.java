 ...
 * @version 1.0
 */
class FileSystemTreeOptionPanel extends PluginOptionsDialogPanel implements
		ActionListener, ItemListener, DockableWindowConstants {
	 ...
	 * Constructor.
	 */
	public FileSystemTreeOptionPanel(Savu rtext, Plugin plugin) {

		super(plugin);
		ResourceBundle gpb = ResourceBundle
				.getBundle("org/fife/ui/app/GUIPlugin");
		ResourceBundle fsvb = ResourceBundle
				.getBundle(FileSystemTreePlugin.BUNDLE_NAME);
	 ...
	 * 
	 * @param placement
	 *            The new dockable window location; should be one of the
	...
	/**
	 * Updates this panel's displayed parameter values to reflect those of this
	 * plugin.
	 */
