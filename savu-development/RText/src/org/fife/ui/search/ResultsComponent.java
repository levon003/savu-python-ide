...
interface ResultsComponent {
	 ...
	 *            The data.
	 * @param dirName
	 *            The "root directory" searching was done in. This is used so
	 *            all file paths displayed in are abbreviated to be relative to
	 *            this directory.
	 * @see #clear()
	 */
	...
	/**
	 * Allows the results component to update its appearance after having lots
	 * of data added to it.
	 */
